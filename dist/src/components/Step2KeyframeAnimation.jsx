...
const Step2KeyframeAnimation = () => {
    ...
    return (<div className="step2-keyframe-anim-root" style={{ position: "relative", width: 260, height: 312 }}>
      <svg width={260} height={312} viewBox="0 0 260 312" fill="none">
        ...
        {pairs.map(({ a, b, }, i) => {
            ...
            const r = lerp((_a = a.r) !== null && _a !== void 0 ? _a : 20, (_b = b.r) !== null && _b !== void 0 ? _b : 20, progress);
            const fill = interpolateColor(a.fill, b.fill, progress);
            const opacity = lerp(a.r && a.r > 0 ? 1 : 0, b.r && b.r > 0 ? 1 : 0, progress);
            const transform = progress < 1 ? a.transform || "" : b.transform || "";
            return (<circle key={i} cx={cx} cy={cy} r={r} fill={fill} opacity={opacity} transform={transform} style={{ transition: "none" }}/>);
        })}
...
exports.default = Step2KeyframeAnimation;
